...
public class AppOpenAd 
{
    ...
    private static AppOpenAd instance;
    ...
    public void LoadAd()
    {
        ...
        GoogleMobileAds.Api.AppOpenAd.LoadAd(AD_UNIT_ID, ScreenOrientation.Portrait, request, ((appOpenAd, error) =>
        {
            if (error != null)
            {
                // Handle the error.
